<%@ Page Title="Sellers" Language="C#" MasterPageFile="~/View/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Sellers.aspx.cs" Inherits="UrbanGarden2._0.View.Admin.Sellers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Mybody" runat="server">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8"><img src="../../Asset/Images/seedling_solid.png" height="auto" width="80px"/><h3 class="text-primary">Manage Sellers</h3></div>
        </div>
        <div class="row">
            <div class="col-md-4">
                ...
                <asp:Button text="      Edit       " class="btn btn-dark text-center btn-hover" runat="server" ID="EditBtn" OnClick="EditBtn_Click"/>
                <asp:Button text="      Save      " class="btn btn-dark text-center" runat="server" ID="SaveBtn" OnClick="SaveBtn_Click" />
                <asp:Button text="      Delete      " class="btn btn-dark text-center" runat="server" ID="DeleteBtn" OnClick="DeleteBtn_Click"/>
                <br /><br /><br /><br /><br />
            </div>
